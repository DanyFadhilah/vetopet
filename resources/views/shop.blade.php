    ...
    <div class="bg_yellow">
        <div class="container">
            <div class="row">
                <div class="bg_putih">
                <div class="col-12">
                    <h1 class="judul">All Category</h1>
                ...
                <div class="col-lg-2 col-md-4 col-6">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text card-harga">Rp.{{$data->harga}}</p>
                        <p class="card-text card-stok">Stok : {{$data->stok}}</p>
                        <form action="{{ route('cart.add') }}" method="POST">
                            @csrf
                            <input type="hidden" name="product_id" value="{{ $data->id }}">
                            <label for="quantity">Quantity :</label>
                            <input type="number" name="quantity" id="quantity" value="1" min="1">
                            <button class="btn_add_cart" type="submit">Add to Cart</button>
                        </form>
                    </div>
                </div>
                </div>
